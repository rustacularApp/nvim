return {
	{
		...
		config = function()
			...
			set({"n", "x"}, "<leader>h<down>", function() mc.lineAddCursor(-1) end)
			set({"n", "x"}, "<leader>h<down>", function() mc.lineAddCursor(1) end)
			set({"n", "x"}, "<leader>hr<up>", function() mc.lineSkipCursor(-1) end)
			set({"n", "x"}, "<leader>hr<down>", function() mc.lineSkipCursor(1) end)
